...
leftpad s a
    | length s >= a = s
    | length s < a = leftpad (addSpace s) a
...
countHelper 0 = "Liftoff!" 
countHelper n = show n ++ "... " ++ countHelper (n-1)

countdown :: Integer -> String
countdown n = "Ready!" ++ countHelper n
...
smallestHelper :: Integer -> Integer -> Integer
smallestHelper n k = if (mod n k == 0) then k else smallestHelper n (k+1)

smallestDivisor :: Integer -> Integer
smallestDivisor n = smallestHelper n 2
